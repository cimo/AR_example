...
namespace ArUi {
    public class ArUiAction : MonoBehaviour {
        ...
        private ArPlacementModel arPlacementOnPlane;
        private ArPlacementAnchor arPlacementAnchor;
        ...
        private void Awake() {
            ...
            arPlacementOnPlane = GameObject.Find("Script container").GetComponent<ArPlacementModel>();
            arPlacementAnchor = GameObject.Find("Script container").GetComponent<ArPlacementAnchor>();
        }
        ...
        private void _eventAnchor(Toggle change) {
            ...
            arPlacementAnchor.isEnabled = change.isOn;
            arPlacementOnPlane.isEnabled = !change.isOn;
        }

        private void _eventSwitchModel() {
            arPlacementOnPlane.switchModel();
        }

        private void _eventAddModel() {
            arPlacementOnPlane.insertModel();
        }
    }
}